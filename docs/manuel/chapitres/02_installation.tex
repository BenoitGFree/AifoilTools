...
\begin{itemize}
    ...
    \item \textbf{Python} : version 3.10 ou supérieure pour le
        solveur XFoil (recommandation : 3.13). Le solveur optionnel
        \emph{FlexFoil} nécessite spécifiquement \textbf{Python 3.11}
        (seules des wheels \code{cp311} sont publiées).
