...
\section{À propos d'AifoilTools}

\textbf{AifoilTools} est une bibliothèque Python d'outils dédiés
...
(docstrings au format Sphinx) et dans le fichier
\chemin{CLAUDE.md} à la racine du dépôt.
...
AifoilTools propose deux modes de représentation des profils :
