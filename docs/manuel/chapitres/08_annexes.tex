...
\begin{itemize}
    \item \textbf{Documentation technique} : voir les docstrings
        du code source (format Sphinx reST) et la documentation
        générée dans le dossier \chemin{docs/}.
    ...
    \item \textbf{Bibliothèque de profils} :
        ...
        (large catalogue au format \chemin{.dat}, accessible
        directement depuis le menu \menu{Fichier $\rightarrow$ Depuis
        la base UIUC} de l'application).
